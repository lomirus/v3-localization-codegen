...
<template>
  <main>
    ...
    <div class="buttons">
      ...
      <button class="download" @click="saveTextFile('l_simp_chinese', smText)">下载</button>
    </div>
    <div class="buttons">
      <button class="copy" @click="copyText(enText)">复制</button>
      <button class="download" @click="saveTextFile('l_english', enText)">下载</button>
    </div>
  </main>
</template>
